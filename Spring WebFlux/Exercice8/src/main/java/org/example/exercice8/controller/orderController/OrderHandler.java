package org.example.exercice8.controller.orderController;
...
public class OrderHandler {
    ...
    public Mono<ServerResponse> getOrderByCustomerName(ServerRequest request) {
        String customerName = request.pathVariable("customerName");
        return ServerResponse.ok().body(orderService.getOrderByCustomerName(customerName), Order.class);
    }
